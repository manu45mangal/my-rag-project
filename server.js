...
// ==========================================
// GLOBALS: Initialize Pinecone once at startup
// ==========================================
...
// ==========================================
// ROUTE: Get Active Namespaces (Dashboard)
// ==========================================
...
// ==========================================
// ROUTE: Delete a Namespace (Dashboard)
// ==========================================
...
// ==========================================
// NOTE: Changed "wordFile" to "document" to match the Salesforce LWC payload and fix the MulterError
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    // NOTE: Added the HTML formatting instruction strictly to the LLM prompt, keeping Pinecone searches clean!
    ...
    const chain = RunnableSequence.from([
      {
        ...
        // The raw question goes to the retriever above, so Pinecone isn't looking for HTML tags
